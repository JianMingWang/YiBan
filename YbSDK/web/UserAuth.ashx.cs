    ...
    public class UserAuth : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                if (obj != null)
                {
                    context.Response.Redirect("Test.aspx?access_token=" + obj.access_token + "&userid=" + obj.userid + "&expires=" + obj.expires + "&data=" + srcString.ToString());//获取成功后
                }
                else
                {
                    context.Response.Redirect("Test.aspx");//未获取到授权
                }
            }
        }
